    ...
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                ...
                <form action="${pageContext.request.contextPath}/admin/activity/add" method="post" class="p-4 border rounded">
                    <div class="mb-3">
                    ...
                    <div class="d-flex gap-2">
                        ...
                        <a href="${pageContext.request.contextPath}/admin/activity" class="btn btn-secondary">
