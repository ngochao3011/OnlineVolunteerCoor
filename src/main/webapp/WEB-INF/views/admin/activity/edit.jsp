...
<section class="blog-section spad">
    <div class="container">
        ...
        <div class="row justify-content-center">
            <div class="col-lg-6">
                <form action="${pageContext.request.contextPath}/admin/activity/edit" method="post" class="p-4 border rounded">
                    ...
                    <a href="${pageContext.request.contextPath}/admin/activity" class="btn btn-secondary">Quay Lại</a>
                </form>
            </div>
        </div>
    </div>
