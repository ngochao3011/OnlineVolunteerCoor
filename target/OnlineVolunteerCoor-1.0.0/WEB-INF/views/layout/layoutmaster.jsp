...
<body id="section_1">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="${pageContext.request.contextPath}/src/images/icons/hands.png" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="${pageContext.request.contextPath}/src/images/icons/heart.png" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0 mb-md-4">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="${pageContext.request.contextPath}/src/images/icons/receive.png" class="featured-block-image img-fluid" alt="">
                    ...
                    <div class="col-lg-3 col-md-6 col-12 mb-4 mb-lg-0">
                        <div class="featured-block d-flex justify-content-center align-items-center">
                            <a href="donate.html" class="d-block">
                                <img src="${pageContext.request.contextPath}/src/images/icons/scholarship.png" class="featured-block-image img-fluid" alt="">
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-5 col-12">
                        <img src="${pageContext.request.contextPath}/src/images/portrait-volunteer-who-organized-donations-charity.jpg"
                            ...
                            <div class="carousel-inner">
                                ...
                                <ol class="carousel-indicators">
                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="0" class="active">
                                        <img src="${pageContext.request.contextPath}/src/images/avatar/portrait-beautiful-young-woman-standing-grey-wall.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>

                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="1" class="">
                                        <img src="${pageContext.request.contextPath}/src/images/avatar/portrait-young-redhead-bearded-male.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>
                                    ...
                                    <li data-bs-target="#testimonial-carousel" data-bs-slide-to="3" class="">
                                        <img src="${pageContext.request.contextPath}/src/images/avatar/studio-portrait-emotional-happy-funny.jpg"
                                            class="img-fluid rounded-circle avatar-image" alt="avatar">
                                    </li>
                                </ol>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-12 mb-4">
                    <img src="${pageContext.request.contextPath}/src/images/logo.png" class="logo img-fluid" alt="">
                </div>
    ...
    <!-- JAVASCRIPT FILES -->
    <script src="${pageContext.request.contextPath}/src/js/jquery.min.js"></script>
    <script src="${pageContext.request.contextPath}/src/js/bootstrap.min.js"></script>
    <script src="${pageContext.request.contextPath}/src/js/jquery.sticky.js"></script>
